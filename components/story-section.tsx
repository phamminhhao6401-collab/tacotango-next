    ...
    >
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
        ...
        <div className="relative mx-auto w-full max-w-md lg:max-w-none">
          <div className="relative aspect-[3/2] w-full rotate-[-2deg] overflow-hidden rounded-2xl border-4 border-blue bg-mustard shadow-retro transition-transform hover:rotate-0">
            <Image
              src="/images/mascot.png"
              alt="Taco Tango Mascot"
              fill
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="font-mono text-base leading-relaxed text-blue">
            ...
            {/* Sử dụng block và mt-4 để tạo dòng trắng (khoảng cách) bên trên slogan */}
            <span className="font-bold text-tomato inline-block mt-4 whitespace-nowrap">
              Taco Tango, giòn tan nhịp vangg!
            </span>
          </p>
        </div>
      </div>
