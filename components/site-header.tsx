        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            {isMounted && totalItems > 0 && (
              <span className="absolute -right-2 -top-2 grid h-6 w-6 place-items-center rounded-full border-2 border-blue bg-mustard text-xs font-bold tracking-wider text-blue">
                {totalItems}
              </span>
            )}
          </Link>
